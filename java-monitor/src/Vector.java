...
public class Vector implements Data {
    ...
    public static int mul(Vector v1, Vector v2, int begin, int end){
        int res = 0;
        for (int i = begin; i <end; i++) {
            res += v1.getElement(i)*v2.getElement(i);
        }
        return res;
    }
    ...
    public static Integer findMax(Vector v,int begin, int end){
        int z=v.getElement(begin);
        for (int i = begin; i <end; i++) {
                if(z<v.getElement(i)){
                    z=v.getElement(i);
                }
